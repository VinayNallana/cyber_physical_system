...
class CameraSensor:
    ...
    def __init__(self, sensor_id: str, fps: int = 30, resolution: Tuple[int, int] = (640, 480)):
        """
        ...
        self.lock = Lock()
        self.frame_count = 0
        logger.info(f"Camera sensor {sensor_id} initialized at {fps} FPS, resolution {resolution}")
    ...
    def capture_frame(self, image_path: Optional[str] = None) -> Dict:
        """
    ...
    def perform_health_check(self) -> bool:
        ...
        self.health_status = "healthy" if np.random.random() > 0.01 else "warning"
...
class EnvironmentalSensor:
    ...
    def __init__(self, sensor_id: str, sensor_type: str, unit: str, 
        ...
        self.health_status = "healthy"
        self.lock = Lock()
        logger.info(f"{sensor_type} sensor {sensor_id} initialized with range {normal_range} {unit}")
