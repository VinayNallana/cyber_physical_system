        ...
        **kwargs,
        ...
        try:
            ...
            training_result = {
                ...
                "final_metrics": {
                    "mAP50": float(
                        results.results_dict.get("metrics/mAP50(B)", 0)
                    ),
                    "mAP50-95": float(
                        results.results_dict.get("metrics/mAP50-95(B)", 0)
                    ),
                    "precision": float(
            ...
            self.training_history.append(
                {"timestamp": datetime.now(), "result": training_result}
            )

            logger.info("Training completed successfully")
            logger.info(
                f"Final mAP50: {training_result['final_metrics']['mAP50']:.4f}"
            )
